    ...
    return (<div className="ms-Grid List ListItem" dir="ltr" onClick={this.DisplayAd.bind(this, this.props.item.id)}>
      <div className="ms-Grid-row">
        ...
        <div className="ms-Grid-col ms-sm7">
          <div className="ms-Grid-col ms-sm2 block Price"><span className="Tag">&#x20b9;</span>{this.props.item.price}</div>
          <div className="ms-Grid-col ms-sm3 block User">
            <div className="ms-Grid-row name">{this.props.item.createdByUser.name}</div>
          ...
          <div className="ms-Grid-col ms-sm2  block Offers">{this.props.item.offersCount}</div>
          <div className="ms-Grid-col ms-sm2 block Comments">{this.props.item.commentsCount}</div>
