...
class ActiveClassifieds extends Component<any, any>
{
    componentDidMount() {
        debugger;
        this.props.dispatch(fetchUserAds(this.props.LoggedInUser.id, "Active", this.props.ActiveAds.length));    /////////user id need to be given in the first field when authentication is added
    }
